...
It does not return True for objects that are instances of the specified class itself,
...
def inherits_from(obj, a_class):
    ...
    This function returns True if the object's class is a subclass (either directly
